...
This model achieved `83.08%` accuracy.
...
This model achieved `91.61%` accuracy.
...
This model acheived `83.79%` accuracy.
...
This model achieved `71.83%` accuracy.
...
This model achieved `96.17%` accuracy.
